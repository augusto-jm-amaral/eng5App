...
//		Seta o CharacterEncoding para utf-8 para que não tenha problemas em manipular letras acentuadas
...
//		Verifica se existir algum caracter depois do barra
		if (pathInfo != null) {
//			Filtra essa string para retirar a barra do inicio e pegar o numero que vem depois			
...
//		caso não tenha nenhum caracter apos o endereço /produto/ ele retornara a lista
		} else {
...
//			Caso der erro exibe o erro no console do servidor e devolve um status 500 = ERRO INTERNO NO SERVIDOR
